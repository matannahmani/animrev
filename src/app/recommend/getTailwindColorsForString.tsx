export function getTailwindColorsForString(input: string): string {
  const colorPairs: string[] = [
    ...
    "text-green-600 bg-green-200 hover:text-green-700 hover:bg-green-300 dark:text-green-300 dark:bg-gray-800 dark:hover:text-green-400 dark:hover:bg-gray-800",
    ...
    "text-red-600 bg-red-200 hover:text-red-700 hover:bg-red-300 dark:text-red-400 dark:bg-gray-800 dark:hover:text-red-500 dark:hover:bg-gray-800",
    ...
    "text-purple-600 bg-purple-200 hover:text-purple-700 hover:bg-purple-300 dark:text-purple-300 dark:bg-gray-800 dark:hover:text-purple-400 dark:hover:bg-gray-800",
    ...
    "text-rose-600 bg-rose-200 hover:text-rose-700 hover:bg-rose-300 dark:text-rose-300 dark:bg-gray-800 dark:hover:text-rose-400 dark:hover:bg-gray-800",
